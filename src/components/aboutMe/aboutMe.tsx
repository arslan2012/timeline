  ...
  render() {
    return (
      <div>
        ...
        <p>
          bisaibang is a company that focuses on online esports event organizing
        </p>
        <p>
          develop, maintain, and support application programs for the company's
          website, using angular and angular.js for web, react-native for
          mobile; automate deployment with GitLab-ci and k8s; and manage a team
        ...
        <p>
          found issues and made pull-requests in angular and jhipster projects.
        </p>
        <p>
          trained and mentored junior programmers in programming methodologies
          and best practices.
        </p>
        ...
        <p>
          using typescript and react-native, ported the websites function into
          ios /android app
        </p>
        <p>streaming widgets (ts)</p>
        <p>using electron, designed an app that helps streaming games</p>
        <p>
          app has two windows, control window controls widget window by sending
          the changes through IPC .
        </p>
        <p>opensource experience</p>
        ...
        <p>
          familiar with node.js full-stack，worked with node / nest/ express；
